...
private:
	...
	std::shared_ptr<int[]> cViewSpace;//current viewspace position.[0] is y (bot to top),[1] is x (left to right) 
	std::shared_ptr<const int[]> viewSpaceLimits;//maximum viewspace. [0] = left,[1] = right,[2] = top,[3] = bottom
